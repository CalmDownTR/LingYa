...
**聊天气泡布局**：
- 她的气泡：左对齐，柔紫背景，max-width 70%
- 用户气泡：右对齐，`#383330` 背景，max-width 70%
...
**圆角柔和克制。** 聊天气泡用 pill 形营造亲密感，按钮和卡片用中等圆角保持干净，不用尖锐直角。
